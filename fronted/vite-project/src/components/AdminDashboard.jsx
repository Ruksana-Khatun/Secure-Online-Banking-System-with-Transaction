...
const AdminDashboard = () => {
  ...
  return (
    <Layout style={{ minHeight: '100vh' }}>
      ...
      <Modal
        title={modalType === 'editAgent' ? 'Edit Agent' : 'Transaction History'}
        visible={modalVisible}
        onCancel={() => setModalVisible(false)}
        footer={null}
        width={modalType.includes('Transactions') ? 1000 : 600}
      >
        {modalType === 'editAgent' && selectedItem && (
          <Form layout="vertical">
            <Form.Item label="Full Name">
              <Input defaultValue={selectedItem.fullName} />
            </Form.Item>
            <Form.Item label="Email">
              <Input defaultValue={selectedItem.email} />
            </Form.Item>
            <Form.Item label="Mobile">
              <Input defaultValue={selectedItem.mobile} />
            </Form.Item>
            <Form.Item label="Address">
              <Input.TextArea defaultValue={selectedItem.address} rows={3} />
            </Form.Item>
            <Form.Item>
              <Space>
